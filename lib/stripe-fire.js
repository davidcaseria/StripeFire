...
module.exports = function (key) {
    ...
    return {
        charges: function (ref, callback, accessToken, alterRequest) {
            ...
            chargesRef.on('child_changes', Charge.update(['description', 'metadata'], callback));
        ...
        coupons: function (ref, callback, accessToken, alterRequest) {
            ...
            couponsRef.on('child_changed', Coupon.update(['metadata'], callback));
        },
        customers: function (ref, callback, accessToken, alterRequest) {
            ...
            customersRef.on('child_changed', Customer.update(['account_balance', 'card', 'coupon', 'default_card', 'description', 'email', 'metadata'], callback));
        ...
        plans: function (ref, callback, accessToken, alterRequest) {
            ...
            plansRef.on('child_changed', Plan.update(['name', 'metadata', 'statement_description'], callback));
        }
    };
};